...
export function getThemeStyles(theme: Theme = 'dark'): Record<string, string> {
  ...
  if (theme === 'light') {
    ...
    vars['--dm-radius'] = '16px';
    vars['--dm-message-bg'] = '#f0fdf4';
    vars['--dm-message-border'] = '#bbf7d0';
    vars['--dm-message-text'] = '#166534';
    ...
    vars['--dm-message-bg'] = 'rgba(245, 158, 11, 0.08)';
    vars['--dm-message-border'] = 'rgba(245, 158, 11, 0.2)';
    vars['--dm-message-text'] = '#f0f6fc';
  } else {
    // Default: 'dark'
    vars['--dm-bg'] = '#0d1117';
    vars['--dm-text'] = '#f0f6fc';
